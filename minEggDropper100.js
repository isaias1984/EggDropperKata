...
to the next floor and the value of minDrops100 increase in one more. If the egg doesn't survive I have finished and I have to return the 
minDrops100 value. 
...
floor, it asks me to find the minDrops100 (egg drops you need to find criticalFloor). I can return the minDrops100 in this case and is logic too, 
or so I think.
...
I have the values: eggs (starts with 100), floors (starts with 100) and minDrops100 (starts with 0). 

I start the loop increasing the value of minDrops100. 

If the egg survives I have finished, I'm at the criticalFloor and I have to return the minDrops100 value. I break the loop and return the 
minDrops100 value. I'm at the critical floor because one of the premises states: If an egg survives a fall from floor n, then it would also 
...
at the ground floor). If I don't have eggs I finished and return the minDrops100 value. If not I'm at the loop again and check if the egg 
survives or not. */
